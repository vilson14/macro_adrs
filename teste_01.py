...
# soup = BeautifulSoup(d_02, "html.parser")
...
fig.update_layout(height=1100, width=1500, title_text="PRE-MARKET - MACRO + ADRS | Variação das 9:00 as 10:00 | Leilão das 10:00 em diante. | " + data_hoje_min + " hs")
